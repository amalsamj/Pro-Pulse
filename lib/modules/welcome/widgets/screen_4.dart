...
class GlassOnboardingPage4 extends StatelessWidget {
  final int pageIndex;

  GlassOnboardingPage4({super.key, required this.pageIndex});
    ...
    return Obx(() {
      ...
      return Stack(
        children: [
          /// Background Image
          Positioned.fill(
            child: Image.asset('assets/images/w5.png', fit: BoxFit.cover),
          ),
              ...
              child: BackdropFilter(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        "Access qualified nurses, lab tests, and physiotherapy — all from the comfort of your home.",
                        style: TextStyle(
                          fontSize: 17.sp,
                          color: Colors.white,
                          height: 1.4,
