...
class GlassOnboardingPage extends StatelessWidget {
  final int pageIndex;
  GlassOnboardingPage({super.key, required this.pageIndex});
    ...
    return Obx(() {
      ...
      return Stack(
        children: [
          /// Background Image
          Positioned.fill(
            child: Image.asset('assets/images/welcome1.jpg', fit: BoxFit.cover),
          ),
              ...
              child: BackdropFilter(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        "From trained nurses to lab tests and physiotherapy, brings expert medical care to your doorstep.",
                        style: TextStyle(
                          fontSize: 17.sp,
                          color: Colors.white,
                          height: 1.4,
